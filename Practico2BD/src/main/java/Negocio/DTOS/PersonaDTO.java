...
public class PersonaDTO {
    ...
    public PersonaDTO(String pNombre, String pApellido, String pCi, String pFechaNacimiento, String pTelefono, String pEmail, LinkedList<RolDTO> pTipos, LinkedList<PersonaMateriaDTO> pMateriaCursando, LinkedList<PersonaMateriaDTO> pMateriaDictando) {
        this.Nombre = pNombre;
